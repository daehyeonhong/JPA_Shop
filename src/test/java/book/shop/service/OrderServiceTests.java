...
class OrderServiceTests {
    ...
    void order() {
        ...
        final Item book = this.createItem("MobyDick", BigDecimal.valueOf(11000), 10);
        ...
        assertEquals(BigDecimal.valueOf(10000).add(BigDecimal.valueOf(orderCount))
    ...
    void orderStockOver() {
        //given
        final Member member = this.createMember();
        final Item item = this.createItem("Snow County", BigDecimal.valueOf(10000), 30);
        //when
    ...
    void cancel() {
        //given
        final Member member = this.createMember();
        final Item item = createItem("La Peste", BigDecimal.valueOf(15000), 20);
        final int orderCount = 2;
